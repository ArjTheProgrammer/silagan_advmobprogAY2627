          ...
          children: [
            ...
            Padding(
              ...
              child: TextField(
                ...
                // ADDED: onChanged event to capture typed text instantly
                onChanged: (value) {
                  setState(() {
            ...
            StreamBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                // ADDED: Filter logic based on _searchText
                ...
                final users = allUsers.where((user) {
                  ...
                  // If _searchText is empty, contains() returns true for everything
